...
version = vre.findall(read(path.join(here, "fourgp_payne", "__init__.py")))[0]
...
setup(
    ...
    description="Spectrum library functions for 4MOST Galactic Pipeline: Wrapper for the Payne",
    ...
    install_requires=["numpy", "scipy", "torchvision"],
    extras_require={
        "test": ["coverage"]
    },
    package_data={
