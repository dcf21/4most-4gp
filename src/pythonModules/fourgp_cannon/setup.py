...
version = vre.findall(read(path.join(here, "fourgp_cannon", "__init__.py")))[0]
...
setup(
    ...
    description="Spectrum library functions for 4MOST Galactic Pipeline: Wrapper for the Cannon",
