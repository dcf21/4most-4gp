...
version = vre.findall(read(path.join(here, "fourgp_pipeline", "__init__.py")))[0]

setup(
    name="fourgp_pipeline",
    version=version,
    author="Dominic Ford",
    author_email="dominic@astro.lu.se",
    description="Pipeline component of the 4MOST Galactic Pipeline",
