...
version = vre.findall(read(path.join(here, "fourgp_degrade", "__init__.py")))[0]
...
setup(
    ...
    description="Spectrum degrading functions for 4MOST Galactic Pipeline, including convolution, resampling and adding noise",
