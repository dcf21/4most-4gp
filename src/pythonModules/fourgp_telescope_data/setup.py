...
version = vre.findall(read(path.join(here, "fourgp_telescope_data", "__init__.py")))[0]

setup(
    name="fourgp_telescope_data",
    version=version,
    author="Dominic Ford",
    author_email="dominic@astro.lu.se",
    description="Telescope data for 4MOST Galactic Pipeline",
