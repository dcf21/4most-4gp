...
4GP comes with a web-based tool for browsing the contents of spectrum libraries. The tool is based on flask, and requires additional Javascript dependencies to be installed using bower. bower is a part of nodeJS and can be installed with the node package manager (npm).
...
Flask will then tell you what web address to point your web browser: the address is usually `http://127.0.0.1:5000`.
